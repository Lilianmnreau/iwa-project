...
import { setCoordonnees } from '../../store/slices/addEmplacementSlice'; // Assurez-vous que le chemin est correct
import { selectCoordonnees } from '../../store/slices/selectors'; // Importer le sélecteur mémorisé
